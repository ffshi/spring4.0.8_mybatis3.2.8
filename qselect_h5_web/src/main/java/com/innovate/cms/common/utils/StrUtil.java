...
public class StrUtil
{
	...
	public static final String POSITIVE_NUM = "^[1-9]\\d*$";
	
	public static final String _NUM = "^\\d*$";
	/**
	 * 
	 * @Title: isPositiveNum
	 * @Description:  是否是正整数
	 ...
	 *
	 */
	public static boolean isPositiveNum(String content) {
		return ReUtil.isMatch(POSITIVE_NUM, content);
	}
	...
	public static boolean isNum(String content) {
		return ReUtil.isMatch(_NUM, content);
	}
	...
	/**
	 * 根据index顺序 对,号分隔的字符串定位替换
	 * @Title: replaceStringByIndex
	 * @Description: 
	 * @param str1   原始字符串
	 * @param str2 准备替换的字符串
	 * @param index 字符串在第几位
	 * @return   如果出错返回原始字符串 <br/>
	 * StrUtil.replaceStringByIndex("1,2,3,", "4", 1) ==> 4,2,3,<br/>
	 * StrUtil.replaceStringByIndex("1,2,3,", "4", 2) ==> 1,4,3,<br/>
	 * StrUtil.replaceStringByIndex("1,2,3,", "4", 3) ==> 1,2,4,
	 * 
	 */
	public static String replaceStringByIndex(String str1,String str2,int index)
	{
		String backStr = "";
		...
		if (index < 0)
		{
			...
			if (index > length)
			{
				...
				for (int j = 0; j < i; j++)
				{
					strings = ArrayUtils.add(strings, "0");
				}
			}
			//移除指定位置数组
			strings = ArrayUtils.remove(strings, index-1);
			//添加指定位置数组
			strings = ArrayUtils.add(strings, index-1, str2);	
			backStr = ArrayUtils.toString(strings);
		}
		//System.err.println(backStr);
		return backStr.substring(1,backStr.length()-1)+",";
	}
	...
	{
		//System.err.println(StrUtil.replaceStringByIndex("3,3,Aaaa,3,31,1,1,1,", "Aaaa", 5));
	
		//数组转字符串
		///System.err.println(arraysToStr(strToArrays("1,2,3,66,99,999,888,5")));
		
		// 0 2 4 6 8 10
		// 1 2 3 4 5 6
		// 2 4 6 8 10 12
		//System.err.println(System.currentTimeMillis());
		/*System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 7));
		System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 8));
		System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 9));
		System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 10));
		System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 11));
		System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 12));
		System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 13));
		System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 14));
		System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 15));
		System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 16));
		System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 17));
		System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 18));
		System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 19));
		System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 20));
		System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 21));
		System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 22));
		System.err.println(StrUtil.replaceStringByIndex("1,2,3,3,3,3,3,3,3,1,1,1,1,", "A", 23));*/
		//System.err.println(System.currentTimeMillis());
	}

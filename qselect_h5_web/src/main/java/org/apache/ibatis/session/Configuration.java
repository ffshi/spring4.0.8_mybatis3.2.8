...
public class Configuration
{
	...
	protected Set<String> lazyLoadTriggerMethods = new HashSet<String>(Arrays.asList(new String[] { "equals", "clone",
			"hashCode", "toString" }));
	...
	/*
	 * A map holds cache-ref relationship. The key is the namespace that references a cache bound to another namespace and the
	 * value is the namespace which the actual cache is bound to.
	 */
	...
	{
		ParameterHandler parameterHandler = mappedStatement.getLang().createParameterHandler(mappedStatement, parameterObject,
				boundSql);
	...
	/*
	 * Parses all the unprocessed statement nodes in the cache. It is recommended to call this method once all the mappers are
	 * added as it provides fail-fast statement validation.
	 */
